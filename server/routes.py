...
def home():
    ...
    person = models.Person.query.filter_by(name=name, date_of_birth=date_of_birth, gender=gender, school_name=school_name, grade_level=grade_level).first()
    if not person:
        person = models.Person(name=name, date_of_birth=date_of_birth, gender=gender, school_name=school_name, grade_level=grade_level)
